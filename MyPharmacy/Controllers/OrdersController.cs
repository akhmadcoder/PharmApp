...
namespace MyPharmacy.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(UserManager<ApplicationUser> userManager, AppDbContext context)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderProductId,ClientId,Quantity,Status,Description")] Order order)
        {
